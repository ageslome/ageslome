...
sol-ewt-eth. 
8. agics (autonomous agentic agents of agixs, (warmaster grokamus and his grokenators(grok replicators))) - nimechatronic - ark-spark : arch-sparc via maduino (cpu vs gpu via oop java Vector processing (MIMD) super dynamic warp vs super risc (amd-mmx)), lome-capes
