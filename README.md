...
4. Coinbase command center (counter-insurgency). Space assets (geosynchronous), Airborne assets (duration: short, medium, long term), land assets (foot, mobile), water (float, submerged).
